...
--
-- Host: localhost
-- Generation Time: Jul 21, 2013 at 04:37 PM
...
--
-- Table structure for table `chartdata_info`
--

CREATE TABLE IF NOT EXISTS `chartdata_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chart_no` int(11) NOT NULL,
  `field_type` int(2) NOT NULL COMMENT '0 for category , 1 for series',
...
--
-- Table structure for table `charts_info`
--

CREATE TABLE IF NOT EXISTS `charts_info` (
  ...
  `show_legend` tinyint(1) NOT NULL,
  `show_datalabels` tinyint(1) NOT NULL,
  `show_sorting` tinyint(1) NOT NULL,
  `enable_exporting` tinyint(1) NOT NULL,
  `enable_printing` tinyint(1) NOT NULL,
  `enable_tabulardata` tinyint(1) NOT NULL,
  `do_transpose` tinyint(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `queries` (
  ...
  `group_clause` varchar(100) NOT NULL,
  `order_clause` varchar(100) NOT NULL,
  `having_clause` varchar(500) NOT NULL,
  `parameterised` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Constraints for table `chartdata_info`
--
ALTER TABLE `chartdata_info`
  ADD CONSTRAINT `chartdata_info_ibfk_1` FOREIGN KEY (`chart_no`) REFERENCES `chartdata_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `charts_info`
--
ALTER TABLE `charts_info`
  ADD CONSTRAINT `charts_info_ibfk_2` FOREIGN KEY (`type`) REFERENCES `chart_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `charts_info_ibfk_1` FOREIGN KEY (`source`) REFERENCES `queries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `query_metadata`
--
ALTER TABLE `query_metadata`
  ADD CONSTRAINT `query_metadata_ibfk_1` FOREIGN KEY (`id`) REFERENCES `queries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
